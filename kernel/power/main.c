...
#define RESUME_BOOST_LITTLE_CPU_QOS_FREQ 1766400
#define RESUME_BOOST_BIG_CPU_QOS_FREQ    2649600
...
void resumeboost_fn(void)
{
       ...
       if(get_resume_wakeup_flag()) {
               /* Fetch little cpupolicy and drive the CPU towards target frequency */
